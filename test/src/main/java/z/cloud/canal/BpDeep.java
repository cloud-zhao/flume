...
/**
 * Created by cloud on 18/1/26.
 */
public class BpDeep {
    private double[][]      layer;              //层变量{[0,0,0],[0,0,0]},一维为层,二维为节点及值
    private double[][]      layerErr;           //节点误差 层表示如上
    private double[][][]    layer_weight;       //节点权重 层表示如上,第三维表示每个节点的下一层节点
    private double[][][]    layer_weight_delta; //节点动量 层表示如上
